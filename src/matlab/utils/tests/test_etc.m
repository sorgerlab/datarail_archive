...
function test_collapse_(testCase)
    ...
    %c0 = collapse_(t1, kns, {}, {});
    c0 = collapse(t1, 'KeyVars', kns);
    verifyEqual(testCase, c0(:, kns), t0(:, kns));

    %c1 = collapse_(t1, kns, vns(end), {@sum});
    c1 = collapse(t1, 'KeyVars', kns, ...
                      'ValVars', vns(end), ...
                      'Aggrs', @sum);
    ...
    %c2 = collapse_(t1, kns, vns, {@sum, @sum, @sum});
    c2 = collapse(t1, 'KeyVars', kns, ...
                      'ValVars', vns, ...
                      'Aggrs', @sum);
    ...
    %c3 = collapse_(t1, kns, vns(1, [2 3]), {@mean, @median});
    c3 = collapse(t1, 'KeyVars', kns, ...
                      'ValVars', vns(1, [2 3]), ...
                      'Aggrs', {@mean, @median});
